...
LEARN MORE
           ...
           <div>
            ...
            <p className="font-light inter mt-6">FirstNet IoT advantages allow first responder agencies and those who support them to quickly and easily deploy devices critical to the mission using a FirstNet SIM that automatically connects to the FirstNet network platform.</p>
            <button className="text-white bg-blue-600 px-6  inter mt-10 text-base sm:text-lg py-3 rounded-full font-medium tracking-wide">
LEARN MORE
    </button>
           </div>
